...
const ImageSlider = () => {
    ...
    const data = [
      ["https://greenviewsolutionsimages.s3-us-west-1.amazonaws.com/HomePage/FullSizedWebp/HorizontalCedarStainedCarousel.webp","Cedar Pickets, Horizontal fencing, 182 linear feet", "We Handle Wood Fences with Precision and Love. Our Fences are Built to the Highest Quality"],
