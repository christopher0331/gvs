...
class Feature5 extends Component {
    ...
    componentDidMount(){
        ...
        for(let i = 1; i < 19; i++){
            projectOneImageArray.push([`https://ik.imagekit.io/greenviewsolutions/featuredprojects/Project5/picture${i}?tr=w-700,h-700`, "custom horizontal fence, 300 linear feet"]);
        }

        this.setState({
            primaryImage: [`https://ik.imagekit.io/greenviewsolutions/featuredprojects/Project5/picture1?tr=w-700,h-700`, "custom horizontal fence, 300 linear feet"],
