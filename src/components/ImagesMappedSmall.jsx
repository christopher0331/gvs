...
const ImageSliderSmall = () => {
    ...
    const dataSmall = [
        ["https://ik.imagekit.io/greenviewsolutions/HomePage/FullSizedWebp/homepage1.webp","Cedar Pickets, Horizontal fencing, 182 linear feet", "From Privacy Structures, to Quality Fences, We've Got You Covered"],
        ["https://ik.imagekit.io/greenviewsolutions/HomePage/FullSizedWebp/homepage2.webp","Commercial Fencing, Chain Link Fence, 16ft tall, 500 linear feet", "Our Commercial Fences are Built to Last and Provide Security and Protection for Decades!"],
