...
const Projects = () => {
    ...
    const CustomMultiFamilyHome = "https://ik.imagekit.io/greenviewsolutions/featuredprojects/Project5/picture23?tr=w-500,h-500";
    const SplitRailFencing = "https://ik.imagekit.io/greenviewsolutions/featuredprojects/Project6/picture1?tr=w-500,h-500";
    const horizontalPrivacyFence = "https://ik.imagekit.io/greenviewsolutions/featuredprojects/Project1/picture13?tr=w-500,h-500";
    const EightftPremiumPrivacy = "https://ik.imagekit.io/greenviewsolutions/featuredprojects/Project3/picture6?tr=w-500,h-500";
    const shortHorizontalDecorativeFence = "https://ik.imagekit.io/greenviewsolutions/featuredprojects/Project4/picture7?tr=w-500,h-500"; 
    const horizontalPrivacyFence2 = "https://ik.imagekit.io/greenviewsolutions/featuredprojects/Project2/picture1?tr=w-500,h-500";
